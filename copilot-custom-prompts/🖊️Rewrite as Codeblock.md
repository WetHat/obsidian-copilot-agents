...
---
Rewrite provided text as a single Markdown fenced code block labeled with the correct language tag
...
## Directives
1. Analyze the code snippet text provided by {} to detect and apply the most suitable language tag (e.g., `python`, `javascript`, `html`, etc.) based on the content.
